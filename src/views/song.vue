<template>
  ...
  <ul class="container mx-auto">
    <li class="p-6 bg-gray-50 border border-gray-200" v-for="comment in sortComments" :key="comment.docID">
      <!-- Comment Author -->
      <div class="mb-5">
...
export default {
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = 'Your comment has been submmited';
